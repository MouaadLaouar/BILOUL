...
const card = [
    ...
    },
    {
        id: 3,
        icon: logo3,
        title: 'Digital Marketing for an Ecommerce Platform Startup',
        description: 'BILOUL’s work has improved brand messaginga and helped increase sales by 210%. They’ve displayed top-notch project management and outstanding customer service — they go above and beyond to ensure the project’s success. Overall, they are flexible, accommodating, and proactive.',
        profile: {
            picture: picture3,
            name: 'Wadoud Daroui',
            role: 'CEO & Founder'
